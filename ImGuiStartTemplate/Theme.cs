...
public class Theme
{
    public static void theme()
    {
        ...
        style.Colors[(int)ImGuiCol.Border] = new Vector4(0.1019607856869698f, 0.1019607856869698f, 0.1019607856869698f, 0.5f);
        ...
        style.Colors[(int)ImGuiCol.SliderGrab] = new Vector4(0.4567339420318604f, 0.3514524102210999f, 0.6824034452438354f, 1.0f);
        style.Colors[(int)ImGuiCol.SliderGrabActive] = new Vector4(0.4549019634723663f, 0.3529411852359772f, 0.6823529601097107f, 1.0f);
        ...
        style.Colors[(int)ImGuiCol.TabActive] = new Vector4(0.4000000059604645f, 0.3490196168422699f, 0.5058823823928833f, 1.0f);
        style.Colors[(int)ImGuiCol.TabUnfocused] = new Vector4(0.2784313857555389f, 0.250980406999588f, 0.3372549116611481f, 1.0f);
        style.Colors[(int)ImGuiCol.TabUnfocusedActive] = new Vector4(0.2784313857555389f, 0.250980406999588f, 0.3372549116611481f, 1.0f);
        ...
        style.Colors[(int)ImGuiCol.NavHighlight] = new Vector4(0.2784313857555389f, 0.250980406999588f, 0.3372549116611481f, 1.0f);
